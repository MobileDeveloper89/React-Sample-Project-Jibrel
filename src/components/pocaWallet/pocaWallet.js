...
class PocaWallet extends React.Component {
    ...
    slide1(){
      return <div className="slide1_div">
          <div className="inner_view"  style={{width: this.state.windowWidth <= 1000 ? window.innerWidth*8/10 : window.innerWidth*7/10}}>
            <div className="title_div" style={{fontSize: this.state.windowWidth <= 1000 ? 34 : 42}}>the poca wallet
      ...
      return <div className="slide2_div">
            <div className="center_inner"  style={{width: this.state.windowWidth <= 1000 ? window.innerWidth*8/10 : window.innerWidth*7/10}}>
              <div className="center_div">
                <div className="title_div" style={{fontSize: this.state.windowWidth <= 1000 ? 34 : 42}}>meet poca...
    ...
    slide3(){
      return <div className="slide3_div">
            <div className="inner_view"  style={{width: this.state.windowWidth <= 1000 ? window.innerWidth*8/10 : window.innerWidth*7/10}}>
              <div className="title_div" style={{fontSize: this.state.windowWidth <= 1000 ? 34 : 42}}>livin'lavida poca...
    ...
    render() {
        return <div className="normal">
            ...
            <div className="swipe_view" style={{marginTop: 60}}>
